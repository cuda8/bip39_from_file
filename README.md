## Private GPU program bip39 for sale price $500
The program reads mnemonic phrases from a text file on the GPU (CUDA)<br>
The program also reads passwords, numbers, words from a file. There are many finds on them.<br>
...
Supports phrase dictionaries up to 16 TB.<br>
